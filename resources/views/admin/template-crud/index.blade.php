        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex mb-3 justify-content-between">
                    ...
                    <span>
                        <a href="/example/export-excel" class="btn btn-primary rounded-pill">
                            Export
                        </a>
...
@include('admin.template-crud.modal')
@endsection
@push('script')
    ...
    <script type="module" src="{{ asset('js/crud/template-crud.js') }}"></script>
    @if (session('success'))
        <script>
            Swal.fire({
        toast: true,
